#!/bin/bash
# Sweep 54 BTC-MR configs: full 365d + fold3-of-4. CONFIRM=0 SL_ATR=1 fixed.
cd /Users/ashish/Documents/beast-trader || exit 1
OUT=/tmp/btcmr_sweep54_sl1.jsonl
: > "$OUT"
for BB in 2 2.5 3; do
  for RL in 10 20 30; do
    ...
    for ADX in 20 25 30; do
      for TS in 16 24; do
        ENV="BTCMR_CONFIRM=0 BTCMR_SL_ATR=1 BTCMR_BB_MULT=$BB BTCMR_RSI_LOW=$RL BTCMR_RSI_HIGH=$RH BTCMR_ADX_MAX=$ADX BTCMR_TIME_STOP_BARS=$TS"
