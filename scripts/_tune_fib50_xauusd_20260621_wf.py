...
_tune_path = Path(__file__).resolve().parent / "_tune_fib50_xauusd_20260621.py"
_spec = importlib.util.spec_from_file_location("_tune_fib50", _tune_path)
...
N_FOLDS = 5
WF_RESULTS_JSON = Path(__file__).resolve().parent / "_tune_fib50_xauusd_20260621_wf_results.json"
