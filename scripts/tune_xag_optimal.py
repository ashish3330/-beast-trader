...
SYM = "XAGUSD"
# XAG baseline: 70% WR, PF 0.90, -$8 (losers too big). Wide SL grid incl tight.
SL_GRID = [0.3, 0.5, 0.7, 1.0, 1.25, 1.5, 2.0, 2.5, 3.0, 3.5]
TRAIL_PROFILES = {
    ...
    "AGGR_LOCK_BE03":       [(2.0, "lock", 1.5), (1.0, "lock", 0.6), (0.7, "lock", 0.4), (0.3, "be", 0.0)],
    "DEFAULT_BE03":         [(8.0, "trail", 0.3), (4.0, "trail", 0.5), (2.0, "trail", 0.6),
                             (1.5, "lock", 0.7), (1.0, "lock", 0.4), (0.5, "lock", 0.15), (0.3, "be", 0.0)],
    "TIGHT_TRAIL_BE03":     [(5.0, "trail", 0.3), (2.0, "trail", 0.4), (1.0, "trail", 0.4),
    ...
    "RUNNER_NO_BE_TIGHT":   [(10.0, "trail", 0.3), (5.0, "trail", 0.4), (2.0, "trail", 0.5),
                             (1.0, "trail", 0.5), (0.7, "lock", 0.4), (0.5, "lock", 0.2)],
    "RUNNER_NO_BE_LOOSE":   [(10.0, "trail", 0.3), (5.0, "trail", 0.5), (2.0, "trail", 0.7),
                             (1.0, "trail", 0.8)],
    "PURE_LOCK":            [(3.0, "lock", 2.5), (2.0, "lock", 1.5), (1.0, "lock", 0.7),
                             (0.5, "lock", 0.3), (0.3, "lock", 0.1)],
}
...
OUT_DIR = ROOT / "backtest" / "results" / f"xag_optim_{DATE_TAG}"
